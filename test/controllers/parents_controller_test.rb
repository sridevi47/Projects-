...
class ParentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parent" do
    assert_difference('Parent.count') do
      post parents_url, params: { parent: { fname: @parent.fname, gender: @parent.gender, lname: @parent.lname } }
    end
  ...
  test "should update parent" do
    patch parent_url(@parent), params: { parent: { fname: @parent.fname, gender: @parent.gender, lname: @parent.lname } }
