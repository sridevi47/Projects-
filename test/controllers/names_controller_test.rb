...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post names_url, params: { name: { birthday: @name.birthday, gender: @name.gender, location: @name.location, mobile: @name.mobile, password: @name.password, username: @name.username } }
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { birthday: @name.birthday, gender: @name.gender, location: @name.location, mobile: @name.mobile, password: @name.password, username: @name.username } }
